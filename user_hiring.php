                    ...
                    <div class="dashboard-inner">
                        ...
                        <ul data-submenu-title="Main Navigation">
                            ...
                            <li ><a href="user_appointment.php"><i class="lni lni-bookmark mr-2"></i>My
                                    Appointments</a></li>
                            <li class="active"><a href="user_hiring.php"><i class="lni lni-briefcase mr-2"></i>My Hirings</a></li>
                            ...
                            <div class="mb-4 tbl-lg rounded overflow-hidden">
                                <div class="table-responsive bg-white">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = "SELECT * FROM appointments where user_id = '$user_id' AND `status`>2";
                                                $result = mysqli_query($conn, $sql);
                                                if($result){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href=""
                                                        class="p-2 text-warning bg-light-warning d-inline-flex align-items-center justify-content-center ml-1">Job Completed</a>
                                                    <?php
                                                        }
                                                    ?>
