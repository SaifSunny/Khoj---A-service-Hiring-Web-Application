...
if (isset($_POST['submit_img'])) {
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
            ...
            // Update Record
            $query2 = "UPDATE `workers` SET `worker_img`='$name' WHERE username='$username'";
            ...
            if ($query_run2 && $query_run3) {
                ...
                window.location.href='worker_profile.php';</script>";
            } 
            else {
                $cls="danger";
...
if (isset($_POST['submit'])) {
    ...
    $cls="";
        ...
        // Update Record
        $query2 = "UPDATE `workers` SET firstname='$firstname',lastname='$lastname',
                                            ...
                                            <form action="" method="POST" enctype='multipart/form-data'
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                    <div style="width: 200px; height: 200px;">
                                                        <img src="./assets/img/workers/<?php echo $image?>" width="100%"
