                ...
                <div class="dashboard-nav">
                    <div class="dashboard-inner">
                        ...
                        <ul data-submenu-title="Main Navigation">
                            ...
                            <li><a href="agency_appointments.php"><i class="lni lni-files mr-2"></i>Manage Appointments</a></li>
                            ...
                            ?>
                            <li class="active"><a href="agency_appointment_history.php"><i class="lni lni-bookmark mr-2"></i>Appointment History</a></li>
                        </ul>
            ...
            <div class="dashboard-content">
                ...
                <div class="row">
                        <div class="colxl-10 col-lg-10 col-md-8">
                            <h1 class="ft-medium">Appointment History</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item text-muted"><a href="agency_home.php">Home</a></li>
                                    <li class="breadcrumb-item"><a href="#" class="theme-cl">Appointment History</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <div class="mb-4 tbl-lg rounded overflow-hidden">
        <div class="table-responsive bg-white">
            <table class="table ">
                ...
                <tbody>
                    <?php 
                        $sql = "SELECT * FROM appointments where agency_id = '$agency_id'  AND `status`>2";
                        $result = mysqli_query($conn, $sql);
                        if($result){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <a href=""
                                class="p-2 text-success bg-light-success d-inline-flex align-items-center justify-content-center ml-1">Job Completed</a>
                            <?php
                                }elseif($status==4){
                            ?>
                            <a href=""
                                class="p-2 text-danger bg-light-danger d-inline-flex align-items-center justify-content-center ml-1">
                                Job Cancelled</a>
                            <?php
                                }
                            ?>
