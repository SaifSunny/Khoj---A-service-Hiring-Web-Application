                ...
                <div class="dashboard-tlbar d-block mb-5">
                    <div class="row">
                        <div class="colxl-10 col-lg-10 col-md-8">
                            <h1 class="ft-medium">Manage Agencies</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item text-muted"><a href="admin_home.php">Home</a></li>
                                    <li class="breadcrumb-item"><a href="#" class="theme-cl">Manage Agencies</a></li>
                                </ol>
                            </nav>
                        </div>
                        <div class="colxl-2 col-lg-1 col-md-2" style="margin-left:40px;">
                            <a href="admin_agency_add.php" class="btn btn-success">Add Agency</a>
