    ...
    if(isset($_POST['submit'])){
        ...
        $extensions_arr = array("jpg","jpeg","png","gif");
            ...
            if (!$query_run->num_rows > 0) {
                ...
                $query = "SELECT * FROM agency WHERE agency_name = '$username' AND category_id = '$category'";
                $query_run = mysqli_query($conn, $query);
                if(!$query_run->num_rows > 0){
                    ...
                    if( in_array($imageFileType,$extensions_arr) ){
                        ...
                        if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                            ...
                            $query2 = "INSERT INTO agency(username,email,`password`,agency_name,contact, established, agency_img, `address`, city, zip,about, category_id)
                            VALUES ('$username', '$email', '$password', '$agency_name', '$contact', '$established', '$name', '$address', '$city', '$zip', '$about', '$category')";
                            $query_run2 = mysqli_query($conn, $query2);
                
                            if ($query_run2) {
                                $cls="success";
                                $error = "Agency Successfully Added.";
                            } 
                            else {
                                $cls="danger";
                ...
                <div class="dashboard-nav">
                    <div class="dashboard-inner">
                        ...
                        <ul data-submenu-title="Main Navigation">
                            ...
                            <li class="active"><a href="admin_agencies.php"><i class="lni lni-apartment mr-2"></i>Manage Agencies</a></li>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="_dashboard_content bg-white rounded mb-4">
                                ...
                                <div class="_dashboard_content_body py-3 px-3">
                                    <form class="row" action="" method="POST" enctype='multipart/form-data' style="padding: 10px 30px;">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="agency_name"
                                                            id="agency_name" placeholder="Enter Agency Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="date" class="form-control" name="established"
                                                            id="established" placeholder="Established">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group" style="padding:10px">
                                                        <label>About the Agency</label>
                                                        <textarea class="form-control" name="about" id="about" placeholder="About the Agency"></textarea>
                                                    </div>
                                                </div>   
