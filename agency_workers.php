                        ...
                        <div class="colxl-10 col-lg-10 col-md-8">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#" class="theme-cl">Manage Workers</a></li>
                                </ol>
                            </nav>
                        </div>
                        <div class="colxl-2 col-lg-1 col-md-2" style="margin-left:40px;">
                        <a href="agency_worker_add.php" class="btn btn-success">Add Workers</a>
                                        ...
                                        <tbody>
                                            <?php 
												...
												if($result){
													...
													$image=$row['worker_img'];
											?>
                                            <tr>
                                                <td>
                                                    <div class="cats-box rounded bg-white d-flex align-items-center">
                                                        <div class="text-center"><img src="assets/img/workers/<?php echo $image?>" class="img-fluid" width="55" alt=""></div>
                                                ...
                                                <td>
                                                    <div class="dash-action">
                                                        <a href="agency_worker_delete.php?id=<?php echo $id?>" class="p-2 circle text-danger bg-light-danger d-inline-flex align-items-center justify-content-center ml-1"><i class="lni lni-trash-can"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php 
